...
def make_source(src_array, height, width, display=True):
...
def add_gaussian_noise(mean, sd, data, display=True):
...
def make_random_source(limits, width, height, number_of_sources, display=True):
